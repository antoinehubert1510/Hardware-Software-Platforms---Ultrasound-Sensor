...
#include "hps_0.h" // importer le fichier h qui a été généré à partir de quartus
...
//-----------------------------------------------------------
	...
	//h2p_led_addr=axi_virtual_base + ( ( unsigned long  )( 0x0 + LED_PIO_BASE ) & ( unsigned long)( HW_FPGA_AXI_MASK ) );
...
//-----------------------------------------------------------
	...
	//write into register to test the adder : pas besoin d'écriture dans notre cas 
